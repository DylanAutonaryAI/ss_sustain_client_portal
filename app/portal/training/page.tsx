    ...
    <>
      ...
      <div className="px-8 py-7 max-w-[760px]">
        ...
        <p className="text-[13px] mb-7" style={{ color: 'var(--text2)' }}>
          Submit your form-check videos here for coach review on your weekly check-in.
        </p>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <div
                key={item.muscle}
                className="px-4 py-3 rounded-[9px]"
                style={{
                  background: 'var(--surface)',
                  border: '1px solid var(--border)',
                  boxShadow: 'var(--shadow-sm)',
        ...
        <div
          className="px-[18px] py-3.5 rounded-r-[9px] text-[13px] leading-[1.7]"
          style={{
            background: 'var(--surface)',
            border: '1px solid var(--border)',
