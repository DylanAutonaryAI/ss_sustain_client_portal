...
interface Lead { name: string; email: string; status: string; created_at: string }
...
export default function ReferralPage() {
  ...
  useEffect(() => {
    fetch('/api/referral/me', { cache: 'no-store' })
      .then(r => r.json())
      .then(d => { setCode(d.code ?? null); setLeads(Array.isArray(d.leads) ? d.leads : []); })
      .catch(() => {})
        ...
        <div className="w-full max-w-[820px]">
          ...
          >
            ...
            <p className="text-[13px] max-w-[460px] mx-auto mb-6 leading-[1.7]" style={{ color: 'var(--text2)' }}>
              Send your personal link to friends. When they sign up, it&apos;s tracked to you automatically — your coach sees every referral.
            </p>
