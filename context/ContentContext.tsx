...
interface ContentContextValue {
  ...
  setSupplements: (items: Supplement[]) => void;
  mindsetTips: MindsetTip[];
  setMindsetTips: (items: MindsetTip[]) => void;
  gymBag: GymBagItem[];
  setGymBag: (items: GymBagItem[]) => void;
  shopping: ShoppingItem[];
  setShopping: (items: ShoppingItem[]) => void;
  nonNeg: NonNegotiable[];
  setNonNeg: (items: NonNegotiable[]) => void;
}
...
export function ContentProvider({ children }: { children: React.ReactNode }) {
  ...
  // Persist to localStorage whenever anything changes (after initial load)
  useEffect(() => {
